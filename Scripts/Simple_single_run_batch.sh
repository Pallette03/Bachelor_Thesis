...
#SBATCH --output=log_Simple.out
#SBATCH --error=err_Simple.out
...
python3 Scripts/KeypointDetector.py --model SimpleModel  --dataset salt_and_pepper --batch_size 17 --val_batch_size 24 --learning_rate 0.00342 --global_image_size 800 --num_epochs 20
