...
class feature_extractor(nn.Module):
    ...
    def __init__(self, in_channels=3):
        ...
        self.lb_block = learnable_block(in_channels=(in_channels*10))
...
class handcrafted_block(nn.Module):
    ...
    def forward(self, x):
        ...
        # # Visualize the handcrafted features
        # fig, axs = plt.subplots(6, 5, figsize=(15, 6))
        # for i, ax in enumerate(axs.flat):
        #     ax.imshow(hc_feats[0, i].detach().cpu().numpy(), cmap='gray')
        #     ax.axis('off')
        # plt.savefig('hc_feats.png')
        # plt.show() 
