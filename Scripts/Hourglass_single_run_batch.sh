...
#SBATCH --output=log_Hourglass.out
#SBATCH --error=err_Hourglass.out
...
python3 Scripts/KeypointDetector.py --model Hourglass_Github  --dataset salt_and_pepper --batch_size 17 --val_batch_size 24 --learning_rate 0.00342 --global_image_size 800 --num_epochs 20
