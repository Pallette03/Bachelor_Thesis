...
python3 Scripts/KeypointDetector.py --model UNet --dataset gaussian_clutter_lateral --batch_size 17 --val_batch_size 24 --learning_rate 0.00342 --global_image_size 800 --num_epochs 30 --lateral_conf top
